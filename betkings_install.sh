...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='kings.conf'
CONFIGFOLDER='/root/.kings'
COIN_DAEMON='kingsd'
COIN_CLI='kings-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/g00tch/BetKings/releases/download/1.0/Kings-2.0-Linux-x86_64.zip'
...
function download_node() {
  ...
  echo -e "${GREEN}This can take a few minutes${NC}"
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Windows Wallet Guide: ${PURPLE}https://github.com/betkings/kings-core/blob/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}kings-cli getinfo. ${CYAN} Compare the Blocks line with the explorer to ensure the VPS is synced${NC}"
 echo -e "${GREEN}kings-cli masternode status${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
